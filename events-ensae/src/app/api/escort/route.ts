...
/* GET /api/escort?eventId= — liste des demandes ouvertes */
...
export async function POST(req: NextRequest) {
    try {
        ...
        const { eventId, title, message, photoUrl, genderPreference } = body as {
            eventId: string;
            title: string;
            message: string;
            photoUrl?: string;
        ...
        // Une seule demande ouverte par utilisateur par événement
...
/* DELETE /api/escort?requestId= — retirer sa demande */
