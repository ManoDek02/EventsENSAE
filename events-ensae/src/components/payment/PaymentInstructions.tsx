...
type Props = {
    ...
    amount: number;
    userName: string;
    /* Déjà signalé (status === PENDING_REVIEW) */
...
export function PaymentInstructions({
    ...
    /* Référence à indiquer dans le virement */
        ...
        <div className={styles.wrap}>
            ...
            <ol className={styles.steps}>
                ...
                <li className={styles.step}>
                    ...
                    <div className={styles.stepContent}>
                        <div className={styles.stepTitle}>Signalez votre paiement</div>
                        <p className={styles.stepDesc}>
                            Une fois le virement effectué, cliquez ci-dessous. L&apos;admin recevra une
                            notification et confirmera votre billet sous peu.
                        </p>
                    </div>
                </li>
            </ol>
                ...
                <div className={styles.confirmed}>
                    ...
                    <div>
                        ...
                        <div className={styles.confirmedSub}>
                            L&apos;admin va vérifier et confirmer votre billet. Vous recevrez un email avec votre QR code.
                        </div>
                    </div>
                </div>
            ) : (
            ...
            <div className={styles.delayNote}>
                <Clock size={13} />
                Confirmation généralement sous 24h en jours ouvrés.
            </div>
        </div>
    );
}